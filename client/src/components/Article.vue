            ...
            <div class="well" style="background: #d3d3c1; margin: -14px 0 0 -10px; height: 60px">
              <div style=" margin: -15px 0 0 0">
                ...
                <div class="col-xs-12" style="">
                  ...
                  <button class="btn btn-warning btn-sm" data-toggle="modal" :data-target="'#updateArticleModal'+article._id" style="float: right; margin-right: 20px; margin-top: -5px;">
                        ...
                        <div class="modal-body">
                          <form class="form-horizontal">
                            <div class="form-group">
                              <label for="disabledInput" class="col-sm-3 control-label">Title : </label>
                              <div class="col-sm-9">
                                <input class="form-control" id="disabledInput" type="text" v-model="article.title">
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="col-xs-8">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-9">
                                <input class="form-control" id="disabledInput" type="text" v-model="article.description">
                              </div>
                            </div>
                          </form>
                        </div>
                  ...
                  <button class="btn btn-danger btn-sm" data-toggle="modal" :data-target="'#deleteArticleModal'+article._id" style="float: right; margin-right: 20px; margin-top: -5px;">
